    ...
    try:
        ...
        if not tabela_itens:
            return JSONResponse(content={
                "erro": "A SEFAZ bloqueou a leitura dos itens por falta do token do QR Code. Por favor, bipe pelo QR Code ou cole o link completo da página."
            }, status_code=400)
        ...
        for tr in tabela_itens.find_all("tr"):
        ...
        # Gravação
        aba_notas.append_row([chave, data_emissao, nome_mercado, valor_total_float, chave, "Processado", url_original])
